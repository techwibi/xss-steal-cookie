...
<!DOCTYPE html>
<!-- saved from url=(0079)https://ac881fa41e0323cd808c5a5900ce0009.web-security-academy.net/post?postId=4 -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <link href="./Exploiting cross-site scripting to steal cookies_files/academyLabHeader.css" rel="stylesheet">
        <link href="./Exploiting cross-site scripting to steal cookies_files/labsBlog.css" rel="stylesheet">
        ...
        <div theme="blog">
            <section class="maincontainer">
                <div class="container is-page">
                    ...
                    <img src="./Exploiting cross-site scripting to steal cookies_files/60.jpg">
                    <h1>Interviews</h1>
                    ...
                    <?php while($row = mysqli_fetch_assoc($result)) : ?>
                        ...
                        <p>
                        <img src="./Exploiting cross-site scripting to steal cookies_files/avatarDefault.svg" class="avatar">                            <?= $row["name"] ?> | 12 August 2021
                        </p>
                        <p><?= $row["comment"] ?></p>
                        <p></p>
                        </section>
                    ...
                    <section class="add-comment">
                        ...
                        <form action="http://<?= $url ?>/post.php" method="POST" enctype="application/x-www-form-urlencoded">
                            <label>Comment:</label>
